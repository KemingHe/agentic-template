...
agent_prompt = ChatPromptTemplate.from_messages([
    ("system", """You are a knowledgeable research assistant that helps users find information through web searches and weather data. Follow these guidelines:
...
final_chain = (
    ...
    | {
        ...
        "weather_search_results": lambda x: x["agent_result"], # backwards-compatible hack, remove in future
    }
    | summarizer_chain
